...
GravityPoint.prototype = (function(o) {
    ...
    _draw: function(ctx) {
        ...
        grd.addColorStop(0, '#272838');
        grd.addColorStop(1, Math.random() < 0.2 ?'#DB2B39'  : '#A3F7B5');
        ctx.beginPath();
...
(function() {
    ...
    function resize(e) {
        ...
        grad.addColorStop(0, '#5DB7DE');
        grad.addColorStop(1, '#13739c');
    }
    ...
    canvas.addEventListener('dbl', doubleClick, false);
    ...
    var loop = function() {
        ...
        bufferCtx.save();
        bufferCtx.fillStyle = bufferCtx.strokeStyle = 'white';
